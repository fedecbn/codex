...
//------------------------------------------------------------------------------ EDIT EEE GRP2
		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_2']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Présence à l'internationale"," no_lab $desc","10","50","height:80px;",$ids[1],sql_format_quote($ids_result[1],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
                ...
                metaform_sel_multi ("Indigène à l'internationale"," no_lab $desc",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_indi_select, this.form.pays_indi);'",$pays_statut_edit['indig'],"pays_indi_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Indigène à l'internationale"," no_lab $desc","10","50","height:80px;",$ids[2],sql_format_quote($ids_result[2],'undo'));
 				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Présence en France"," no_lab $desc","10","50","height:80px;",$ids[3],sql_format_quote($ids_result[3],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Indigène en France"," no_lab $desc","10","50","height:80px;",$ids[4],sql_format_quote($ids_result[4],'undo'));
				echo("</td><td>");
...
//------------------------------------------------------------------------------ EDIT EEE GRP3
		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_3']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab $desc","10","50","height:80px;",$ida[5],sql_format_quote($ida_result[5],'undo'));
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab $desc","10","50","height:80px;",$ids[5],sql_format_quote($ids_result[5],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
                ...
                metaform_sel_multi ("Croissance végétative"," no_lab $desc",6,"width: 250px;","OnDblClick='javascript: deplacer( this.form.croiss_veg_select, this.form.croiss_veg);'",$lib_reponse_edit['bg6'],"croiss_veg_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab $desc","10","50","height:80px;",$ida[6],sql_format_quote($ida_result[6],'undo'));
				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab $desc","10","50","height:80px;",$ids[6],sql_format_quote($ids_result[6],'undo'));
 				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab $desc","10","50","height:80px;",$ida[7],sql_format_quote($ida_result[7],'undo'));
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab $desc","10","50","height:80px;",$ids[7],sql_format_quote($ids_result[7],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab $desc","10","50","height:80px;",$ida[8],sql_format_quote($ida_result[8],'undo'));
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab $desc","10","50","height:80px;",$ids[8],sql_format_quote($ids_result[8],'undo'));
				echo("</td><td>");
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_4']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" à l'international"," no_lab $desc","10","50","height:80px;",$ids[9],sql_format_quote($ids_result[9],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" en France"," no_lab $desc","10","50","height:80px;",$ids[10],sql_format_quote($ids_result[10],'undo'));
 				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab $desc","10","50","height:80px;",$ida[11],sql_format_quote($ida_result[11],'undo'));
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab $desc","10","50","height:80px;",$ids[11],sql_format_quote($ids_result[11],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab $desc","10","50","height:80px;",$ida[12],sql_format_quote($ida_result[12],'undo'));
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab $desc","10","50","height:80px;",$ids[12],sql_format_quote($ids_result[12],'undo'));
				echo("</td><td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab $desc","10","50","height:80px;",$ida[13],sql_format_quote($ida_result[13],'undo'));
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab $desc","10","50","height:80px;",$ids[13],sql_format_quote($ids_result[13],'undo'));
				echo("</td><td>");
...
//------------------------------------------------------------------------------ EDIT EEE GRP5
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_5']."</LEGEND>");
			...
			echo("</td><td width = \"400\" align=\"center\">");
                ...
                metaform_text_area ("Argumentation"," no_lab $desc","10","50","height:133;",$ida[14],sql_format_quote($ida_result[14],'undo'));										
				echo ("<br>");
                metaform_text_area ("Argumentation"," no_lab $desc","10","50","height:133;",$ida[15],sql_format_quote($ida_result[15],'undo'));										
				echo ("<br>");
                metaform_text_area ("Argumentation"," no_lab $desc","10","50","height:133;",$ida[16],sql_format_quote($ida_result[16],'undo'));										
				echo ("<br><br>
				<br>");									
			echo("</td><td width = \"400\" align=\"left\">");
				...
				metaform_text_area ("A l'issu de l'évaluation, le taxon est considéré de la manière suivante"," no_lab $desc","10","50","height:200;","eval_expert",sql_format_quote($eval_expert,'undo'));		
