...
//------------------------------------------------------------------------------ EDIT EEE GRP2
		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_2']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Présence à l'internationale"," no_lab $desc","10","50","height:80px;",$ids[1],sql_format_quote($ids_result[1],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Présence à l'internationale"," no_lab $desc",$fiab[1],$fiab_result[1]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
                ...
                metaform_sel_multi ("Indigène à l'internationale"," no_lab $desc",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_indi_select, this.form.pays_indi);'",$pays_statut_edit['indig'],"pays_indi_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Indigène à l'internationale"," no_lab $desc","10","50","height:80px;",$ids[2],sql_format_quote($ids_result[2],'undo_html'));
 				echo("</td><td>");
                metaform_bout ("Indigène à l'internationale"," no_lab $desc",$fiab[2],$fiab_result[2]);				
 				echo("</td></tr>");
			// echo ("<tr valign=top >");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Présence en France"," no_lab $desc","10","50","height:80px;",$ids[3],sql_format_quote($ids_result[3],'undo_html'));
				echo("</td><td>");
				metaform_bout ("Présence en France"," no_lab $desc",$fiab[3],$fiab_result[3]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				...
				echo("</td><td>");
                metaform_text_area ("Indigène en France"," no_lab $desc","10","50","height:80px;",$ids[4],sql_format_quote($ids_result[4],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Indigène en France"," no_lab $desc",$fiab[4],$fiab_result[4]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
		echo ("</div>");
//------------------------------------------------------------------------------ EDIT EEE GRP3
		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_3']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab $desc","10","50","height:80px;",$ida[5],sql_format_quote($ida_result[5],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab $desc","10","50","height:80px;",$ids[5],sql_format_quote($ids_result[5],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Viabilité des graines et reproduction"," no_lab $desc",$fiab[5],$fiab_result[5]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
                ...
                metaform_sel_multi ("Croissance végétative"," no_lab $desc",6,"width: 250px;","OnDblClick='javascript: deplacer( this.form.croiss_veg_select, this.form.croiss_veg);'",$lib_reponse_edit['bg6'],"croiss_veg_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab $desc","10","50","height:80px;",$ida[6],sql_format_quote($ida_result[6],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab $desc","10","50","height:80px;",$ids[6],sql_format_quote($ids_result[6],'undo_html'));
 				echo("</td><td>");
                metaform_bout ("Croissance végétative"," no_lab $desc",$fiab[6],$fiab_result[6]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top >");
				echo("<td>");
				...
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab $desc","10","50","height:80px;",$ida[7],sql_format_quote($ida_result[7],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab $desc","10","50","height:80px;",$ids[7],sql_format_quote($ids_result[7],'undo_html'));
				echo("</td><td>");
				metaform_bout ("Mode dispersion"," no_lab $desc",$fiab[7],$fiab_result[7]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				...
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab $desc","10","50","height:80px;",$ida[8],sql_format_quote($ida_result[8],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab $desc","10","50","height:80px;",$ids[8],sql_format_quote($ids_result[8],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Type biologique"," no_lab $desc",$fiab[8],$fiab_result[8]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
		echo ("</div>");
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_4']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" à l'international"," no_lab $desc","10","50","height:80px;",$ids[9],sql_format_quote($ids_result[9],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Statut \"invasive avérée\" à l'international"," no_lab $desc",$fiab[9],$fiab_result[9]);	// mettre le bon ids?				
				echo("</td></tr>");
			// echo ("<tr valign=top>");
				// echo ("<td><h4>France</h4></td>");			  
				// echo ("<td><h4>les régions concernés</h4></td>");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" en France"," no_lab $desc","10","50","height:80px;",$ids[10],sql_format_quote($ids_result[10],'undo_html'));
 				echo("</td><td>");
                metaform_bout ("Statut \"invasive avérée\" en France"," no_lab $desc",$fiab[10],$fiab_result[10]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top>");
				echo ("<td><h3 style=\"margin-left:165px;margin-right:35px;\">Liste de choix</h3></td>");
				echo ("<td><h3 style=\"margin-right:25px\">Choix réalisés</h3></td><");
			...
			echo ("<tr valign=top >");
				...
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab $desc","10","50","height:80px;",$ida[11],sql_format_quote($ida_result[11],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab $desc","10","50","height:80px;",$ids[11],sql_format_quote($ids_result[11],'undo_html'));
				echo("</td><td>");
				metaform_bout ("Taxonomie"," no_lab $desc",$fiab[11],$fiab_result[11]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				...
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab $desc","10","50","height:80px;",$ida[12],sql_format_quote($ida_result[12],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab $desc","10","50","height:80px;",$ids[12],sql_format_quote($ids_result[12],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Habitat de l'espèce"," no_lab $desc",$fiab[12],$fiab_result[12]);				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				...
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab $desc","10","50","height:80px;",$ida[13],sql_format_quote($ida_result[13],'undo_html'));
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab $desc","10","50","height:80px;",$ids[13],sql_format_quote($ids_result[13],'undo_html'));
				echo("</td><td>");
                metaform_bout ("Densité de la population"," no_lab $desc",$fiab[13],$fiab_result[13]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
			echo ("</div>");
