...
//------------------------------------------------------------------------------ REF. EEE
        ...
        if (!is_null($eval_temp))
			{
			while ($row=pg_fetch_array ($result,NULL,PGSQL_ASSOC))
				$eval[$row['code_question']] = max($eval_temp[$row['code_question']]);		/*Récupèrer le maximum pour le critère évalué*/
...
//------------------------------------------------------------------------------ EDIT EEE GRP1
		...
		echo ("<fieldset><LEGEND>".$lang[$lang_select]['groupe_eee_1']."</LEGEND>");
				...
				<input type=\"text\" name=\"nom_sci\" id=\"nom_sci\" disabled style=\"width:30em;\" maxlength=\"250\" value=\"".pg_result($result,0,"nom_sci")."\" />");
                metaform_sel ("Rang","","disabled ",$rang,"lib_rang",pg_result($result,0,"lib_rang"));
                echo ("<br>");
                metaform_text ("Nom vernaculaire","","","disabled style=width:50em;","nom_verna",pg_result($result,0,"nom_verna"));
...
//------------------------------------------------------------------------------ EDIT EEE GRP2
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_2']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Présence à l'internationale","","multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.pays_pres, this.form.pays_pres_select);'",$pays_statut_reste['pres'],"pays_pres","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.pays_pres_select, this.form.pays_pres);'",$pays_statut_edit['pres'],"pays_pres_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[1],$ids_result[1]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[1],$fiab_result[1]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Indigène à l'internationale","","multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.pays_indi, this.form.pays_indi_select);'",$pays_statut_reste['indig'],"pays_indi","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.pays_indi_select, this.form.pays_indi);'",$pays_statut_edit['indig'],"pays_indi_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[2],$ids_result[2]);
 				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[2],$fiab_result[2]);				
 				echo("</td></tr>");
			// echo ("<tr valign=top >");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Présence en France",""," multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.reg_pres, this.form.reg_pres_select);'",$region_statut_reste['pres'],"reg_pres","");
                echo("</td><td>");
				metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.reg_pres_select, this.form.reg_pres);'",$region_statut_edit['pres'],"reg_pres_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[3],$ids_result[3]);
				echo("</td><td>");
				metaform_bout_plus ("","no_lab",$fiab[3],$fiab_result[3]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Indigène en France","","multiple size=5  style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.reg_indi, this.form.reg_indi_select);'",$region_statut_reste['indig'],"reg_indi","");
				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.reg_indi_select, this.form.reg_indi);'",$region_statut_edit['indig'],"reg_indi_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[4],$ids_result[4]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[4],$fiab_result[4]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
//------------------------------------------------------------------------------ EDIT EEE GRP3
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_3']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Viabilité des graines et reproduction","","multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.viab_graine, this.form.viab_graine_select);'",$lib_reponse_reste['bg5'],"viab_graine","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.viab_graine_select, this.form.viab_graine);'",$lib_reponse_edit['bg5'],"viab_graine_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[5],$ida_result[5]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[5],$ids_result[5]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[5],$fiab_result[5]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Croissance végétative","","multiple size=6 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.croiss_veg, this.form.croiss_veg_select);'",$lib_reponse_reste['bg6'],"croiss_veg","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.croiss_veg_select, this.form.croiss_veg);'",$lib_reponse_edit['bg6'],"croiss_veg_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[6],$ida_result[6]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[6],$ids_result[6]);
 				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[6],$fiab_result[6]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Mode dispersion",""," multiple size=7 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.mod_disp, this.form.mod_disp_select);'",$lib_reponse_reste['bg7'],"mod_disp","");
                echo("</td><td>");
				metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.mod_disp_select, this.form.mod_disp);'",$lib_reponse_edit['bg7'],"mod_disp_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[7],$ida_result[7]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[7],$ids_result[7]);
				echo("</td><td>");
				metaform_bout_plus ("","no_lab",$fiab[7],$fiab_result[7]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Type biologique","","multiple size=7  style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.type_bio, this.form.type_bio_select);'",$lib_reponse_reste['bg8'],"type_bio","");
				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.type_bio_select, this.form.type_bio);'",$lib_reponse_edit['bg8'],"type_bio_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[8],$ida_result[8]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[8],$ids_result[8]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[8],$fiab_result[8]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
//------------------------------------------------------------------------------ EDIT EEE GRP4
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_4']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Statut \"invasive avérée\" à l'international","","multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.st_nvav_inter, this.form.st_nvav_inter_select);'",$pays_statut_reste['invav'],"st_nvav_inter","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.st_nvav_inter_select, this.form.st_nvav_inter);'",$pays_statut_edit['invav'],"st_nvav_inter_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[9],$ids_result[9]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[9],$fiab_result[9]);	// mettre le bon ids?				
				echo("</td></tr>");
			// echo ("<tr valign=top>");
				// echo ("<td><h4>France</h4></td>");			  
				// echo ("<td><h4>les régions concernés</h4></td>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Statut \"invasive avérée\" en France","","multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.st_nvav_fr, this.form.st_nvav_fr_select);'",$region_statut_reste['invav'],"st_nvav_fr","");
 				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.st_nvav_fr_select, this.form.st_nvav_fr);'",$region_statut_edit['invav'],"st_nvav_fr_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[10],$ids_result[10]);
 				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[10],$fiab_result[10]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top>");
				echo ("<td><h3 style=\"margin-left:165px;margin-right:35px;\">Liste de choix</h3></td>");
				echo ("<td><h3 style=\"margin-right:25px\">Choix réalisés</h3></td><");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Taxonomie",""," multiple size=5 style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.taxo, this.form.taxo_select);'",$lib_reponse_reste['cg10'],"taxo","");
                echo("</td><td>");
				metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.taxo_select, this.form.taxo);'",$lib_reponse_edit['cg10'],"taxo_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[11],$ida_result[11]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[11],$ids_result[11]);
				echo("</td><td>");
				metaform_bout_plus ("","no_lab",$fiab[11],$fiab_result[11]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Habitat de l'espèce","","multiple size=5  style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.habt, this.form.habt_select);'",$lib_reponse_reste['cg11'],"habt","");
				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.habt_select, this.form.habt);'",$lib_reponse_edit['cg11'],"habt_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[12],$ida_result[12]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[12],$ids_result[12]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[12],$fiab_result[12]);				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Densité de la population","","multiple size=5  style=\"width: 250px;\"  OnDblClick='javascript: deplacer( this.form.dens_pop, this.form.dens_pop_select);'",$lib_reponse_reste['cg12'],"dens_pop","");
				echo("</td><td>");
                metaform_sel_multi ("","no_lab","style=\"width: 250px;\" multiple size=5 OnDblClick='javascript: deplacer( this.form.dens_pop_select, this.form.dens_pop);'",$lib_reponse_edit['cg12'],"dens_pop_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ida[13],$ida_result[13]);
				echo("</td><td>");
                metaform_text_area ("","no_lab","10","50","style=\"height:80px;\"",$ids[13],$ids_result[13]);
				echo("</td><td>");
                metaform_bout_plus ("","no_lab",$fiab[13],$fiab_result[13]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
//------------------------------------------------------------------------------ EDIT EEE GRP5
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_5']."</LEGEND>");
			...
			echo ("<tr valign=top>");
				...
				metaform_text ("Question A1","","15","readonly","indct_a1",$eval["ag1"]); 				
				metaform_text ("Question A2","","15","readonly","indct_a2",$eval["ag2"]); 				
				metaform_text ("Question A3","","15","readonly","indct_a3",$eval["ag3"]);			
				metaform_text ("Question A4","","15","readonly","indct_a4",$eval["ag4"]);				
				metaform_text ("Sous-total A","","15","readonly","ss_tot_a",$eval["ag"]);
				echo ("<br>");				
				metaform_text ("Question B5","","15","readonly","indct_b5",$eval["bg5"]); 				
				metaform_text ("Question B6","","15","readonly","indct_b6",$eval["bg6"]); 				
				metaform_text ("Question B7","","15","readonly","indct_b7",$eval["bg7"]); 				
				metaform_text ("Question B8","","15","readonly","indct_b8",$eval["bg8"]); 				
				metaform_text ("Sous-total B","","15","readonly","ss_tot_b",$eval["bg"]);
				echo ("<br>");								
				metaform_text ("Question C9","","15","readonly","indct_c9",$eval["cg9"]); 				
				metaform_text ("Question C10","","15","readonly","indct_c10",$eval["cg10"]); 				
				metaform_text ("Question C11","","15","readonly","indct_c11",$eval["cg11"]); 				
				metaform_text ("Question C12","","15","readonly","indct_c12",$eval["cg12"]); 				
				metaform_text ("Sous-total C","","15","readonly","ss_tot_c",$eval["cg"]); 
				echo ("<br>");					
				metaform_text ("Total","","15","","tot_indct",$eval["ag"]+$eval["bg"]+$eval["cg"]); 				
				...
				echo ("<h3 style=\"margin-left:25px;margin-right:25px;\">Risques</h3>");
					...
					metaform_text_area ("","no_lab","10","50","readonly style=\"height:133;width:100;resize:none;\"","eval_a",$eval_a);	
					echo ("<br>");	
					if ($eval["ag"] <=7){$eval_b = 'FAIBLE';} else {$eval_b = 'FORT';}
					metaform_text_area ("","no_lab","10","50","readonly style=\"height:133;width:100;resize:none;\"","eval_b",$eval_b);	
					echo ("<br>");	
					if ($eval["ag"] <=6){$eval_c = 'FAIBLE';} else {$eval_c = 'FORT';}
					metaform_text_area ("","no_lab","10","50","readonly style=\"height:133;width:100;resize:none;\"","eval_c",$eval_b);	
					echo ("<br>");	
					if ($eval["tot"] <=20){$eval_tot = 'FAIBLE';}elseif ($tot["ind_tot"] > 20 AND $tot["ind_tot"] <= 27){$eval_tot = 'INTERMEDIAIRE';}else{$eval_tot = 'FORT';}
				metaform_text_area ("","no_lab","10","50","readonly style=\"height:30;width:100;resize:none;\"","eval_tot",$eval_tot);																		
			echo("</td><td width = \"400\" align=\"center\">");
				echo ("<h3 style=\"margin-left:30px;margin-right:30px;\">Argumentation</h3>");
                metaform_text_area ("","no_lab","10","50","style=\"height:133;\"",$ida[14],$ida_result[14]);										
				echo ("<br>");
                metaform_text_area ("","no_lab","10","50","style=\"height:133;\"",$ida[15],$ida_result[15]);										
				echo ("<br>");
                metaform_text_area ("","no_lab","10","50","style=\"height:133;\"",$ida[16],$ida_result[16]);										
				echo ("<br><br>
				<br>");									
			echo("</td><td width = \"400\" align=\"left\">");
				// echo ("<h3>Niveau de fiabilité de l'évaluation</h3>");
				// metaform_text_area ("","no_lab","10","50","style=\"height:133;width:100;resize:none;\"","fiaba","");
				// echo ("<br>");
                // metaform_text_area ("","no_lab","10","50","style=\"height:133;width:100;resize:none;\"","fiabb","");
				// echo ("<br>");
                // metaform_text_area ("","no_lab","10","50","style=\"height:133;width:100;resize:none;\"","fiabc","");										
				// echo ("<br>");
                // metaform_text_area ("","no_lab","10","50","style=\"height:30;width:100;resize:none;\"","fiabtot","");
				...
				metaform_text_area ("A l'issu de l'évaluation, le taxon est considéré de la manière suivante","no_lab","10","50","style=\"height:200;\"","eval_expert",$eval_expert);		
				echo ("<h3 style=\"margin-right:40px\">Statuts de l'espèce</h3>");
				metaform_sel ("Le taxon appartient à la ","","",$liste_eval,"liste_eval",$liste_eval_base);
				echo ("<br>");
				metaform_sel ("Le taxon est","","",$carac_emerg,"carac_emerg",$carac_emerg_base);
				echo ("<br>");
				metaform_sel ("Caractère envahissant","","",$carac_avere,"carac_avere",$carac_avere_base);
