		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_2']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				...
				metaform_sel_multi ("Présence à l'internationale",$desc,5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_pres, this.form.pays_pres_select);'",$pays_statut_reste['pres'],"pays_pres","");
 				echo("</td><td>");
                metaform_sel_multi ("Présence à l'internationale"," no_lab",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_pres_select, this.form.pays_pres);'",$pays_statut_edit['pres'],"pays_pres_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Présence à l'internationale"," no_lab","10","50","height:80px;",$ids[1],$ids_result[1]);
				echo("</td><td>");
                metaform_bout_plus ("Présence à l'internationale"," no_lab",$fiab[1],$fiab_result[1]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Indigène à l'internationale","",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_indi, this.form.pays_indi_select);'",$pays_statut_reste['indig'],"pays_indi","");
 				echo("</td><td>");
                metaform_sel_multi ("Indigène à l'internationale"," no_lab",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.pays_indi_select, this.form.pays_indi);'",$pays_statut_edit['indig'],"pays_indi_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Indigène à l'internationale"," no_lab","10","50","height:80px;",$ids[2],$ids_result[2]);
 				echo("</td><td>");
                metaform_bout_plus ("Indigène à l'internationale"," no_lab",$fiab[2],$fiab_result[2]);				
 				echo("</td></tr>");
			// echo ("<tr valign=top >");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Présence en France",null,5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.reg_pres, this.form.reg_pres_select);'",$region_statut_reste['pres'],"reg_pres","");
                echo("</td><td>");
				metaform_sel_multi ("Présence en France"," no_lab",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.reg_pres_select, this.form.reg_pres);'",$region_statut_edit['pres'],"reg_pres_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Présence en France"," no_lab","10","50","height:80px;",$ids[3],$ids_result[3]);
				echo("</td><td>");
				metaform_bout_plus ("Présence en France"," no_lab",$fiab[3],$fiab_result[3]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Indigène en France","",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.reg_indi, this.form.reg_indi_select);'",$region_statut_reste['indig'],"reg_indi","");
				echo("</td><td>");
                metaform_sel_multi ("Indigène en France"," no_lab",5,"width: 190px;","OnDblClick='javascript: deplacer( this.form.reg_indi_select, this.form.reg_indi);'",$region_statut_edit['indig'],"reg_indi_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Indigène en France"," no_lab","10","50","height:80px;",$ids[4],$ids_result[4]);
				echo("</td><td>");
                metaform_bout_plus ("Indigène en France"," no_lab",$fiab[4],$fiab_result[4]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
		echo ("</div>");
//------------------------------------------------------------------------------ EDIT EEE GRP3
		...
		echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_3']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Viabilité des graines et reproduction",null,5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.viab_graine, this.form.viab_graine_select);'",$lib_reponse_reste['bg5'],"viab_graine","");
 				echo("</td><td>");
                metaform_sel_multi ("Viabilité des graines et reproduction"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.viab_graine_select, this.form.viab_graine);'",$lib_reponse_edit['bg5'],"viab_graine_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab","10","50","height:80px;",$ida[5],$ida_result[5]);
				echo("</td><td>");
                metaform_text_area ("Viabilité des graines et reproduction"," no_lab","10","50","height:80px;",$ids[5],$ids_result[5]);
				echo("</td><td>");
                metaform_bout_plus ("Viabilité des graines et reproduction"," no_lab",$fiab[5],$fiab_result[5]);	// mettre le bon ids?				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Croissance végétative",null,6,"width: 250px;","OnDblClick='javascript: deplacer( this.form.croiss_veg, this.form.croiss_veg_select);'",$lib_reponse_reste['bg6'],"croiss_veg","");
 				echo("</td><td>");
                metaform_sel_multi ("Croissance végétative"," no_lab",6,"width: 250px;","OnDblClick='javascript: deplacer( this.form.croiss_veg_select, this.form.croiss_veg);'",$lib_reponse_edit['bg6'],"croiss_veg_select","");echo ("<br>");
 				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab","10","50","height:80px;",$ida[6],$ida_result[6]);
				echo("</td><td>");
                metaform_text_area ("Croissance végétative"," no_lab","10","50","height:80px;",$ids[6],$ids_result[6]);
 				echo("</td><td>");
                metaform_bout_plus ("Croissance végétative"," no_lab",$fiab[6],$fiab_result[6]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Mode dispersion",null,7,"width: 250px;","OnDblClick='javascript: deplacer( this.form.mod_disp, this.form.mod_disp_select);'",$lib_reponse_reste['bg7'],"mod_disp","");
                echo("</td><td>");
				metaform_sel_multi ("Mode dispersion"," no_lab",7,"width: 250px;","OnDblClick='javascript: deplacer( this.form.mod_disp_select, this.form.mod_disp);'",$lib_reponse_edit['bg7'],"mod_disp_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab","10","50","height:80px;",$ida[7],$ida_result[7]);
				echo("</td><td>");
                metaform_text_area ("Mode dispersion"," no_lab","10","50","height:80px;",$ids[7],$ids_result[7]);
				echo("</td><td>");
				metaform_bout_plus ("Mode dispersion"," no_lab",$fiab[7],$fiab_result[7]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Type biologique","",7,"width: 250px;","OnDblClick='javascript: deplacer( this.form.type_bio, this.form.type_bio_select);'",$lib_reponse_reste['bg8'],"type_bio","");
				echo("</td><td>");
                metaform_sel_multi ("Type biologique"," no_lab",7,"width: 250px;","OnDblClick='javascript: deplacer( this.form.type_bio_select, this.form.type_bio);'",$lib_reponse_edit['bg8'],"type_bio_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab","10","50","height:80px;",$ida[8],$ida_result[8]);
				echo("</td><td>");
                metaform_text_area ("Type biologique"," no_lab","10","50","height:80px;",$ids[8],$ids_result[8]);
				echo("</td><td>");
                metaform_bout_plus ("Type biologique"," no_lab",$fiab[8],$fiab_result[8]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
		echo ("</div>");
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_4']."</LEGEND>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Statut \"invasive avérée\" à l'international",null,5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.st_nvav_inter, this.form.st_nvav_inter_select);'",$pays_statut_reste['invav'],"st_nvav_inter","");
 				echo("</td><td>");
                metaform_sel_multi ("Statut \"invasive avérée\" à l'international"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.st_nvav_inter_select, this.form.st_nvav_inter);'",$pays_statut_edit['invav'],"st_nvav_inter_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" à l'international"," no_lab","10","50","height:80px;",$ids[9],$ids_result[9]);
				echo("</td><td>");
                metaform_bout_plus ("Statut \"invasive avérée\" à l'international"," no_lab",$fiab[9],$fiab_result[9]);	// mettre le bon ids?				
				echo("</td></tr>");
			// echo ("<tr valign=top>");
				// echo ("<td><h4>France</h4></td>");			  
				// echo ("<td><h4>les régions concernés</h4></td>");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Statut \"invasive avérée\" en France",null,5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.st_nvav_fr, this.form.st_nvav_fr_select);'",$region_statut_reste['invav'],"st_nvav_fr","");
 				echo("</td><td>");
                metaform_sel_multi ("Statut \"invasive avérée\" en France"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.st_nvav_fr_select, this.form.st_nvav_fr);'",$region_statut_edit['invav'],"st_nvav_fr_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Statut \"invasive avérée\" en France"," no_lab","10","50","height:80px;",$ids[10],$ids_result[10]);
 				echo("</td><td>");
                metaform_bout_plus ("Statut \"invasive avérée\" en France"," no_lab",$fiab[10],$fiab_result[10]);				
 				echo("</td></tr>");	
			echo ("<tr valign=top>");
				echo ("<td><h3 style=\"margin-left:165px;margin-right:35px;\">Liste de choix</h3></td>");
				echo ("<td><h3 style=\"margin-right:25px\">Choix réalisés</h3></td><");
			...
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Taxonomie","",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.taxo, this.form.taxo_select);'",$lib_reponse_reste['cg10'],"taxo","");
                echo("</td><td>");
				metaform_sel_multi ("Taxonomie"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.taxo_select, this.form.taxo);'",$lib_reponse_edit['cg10'],"taxo_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab","10","50","height:80px;",$ida[11],$ida_result[11]);
				echo("</td><td>");
                metaform_text_area ("Taxonomie"," no_lab","10","50","height:80px;",$ids[11],$ids_result[11]);
				echo("</td><td>");
				metaform_bout_plus ("Taxonomie"," no_lab",$fiab[11],$fiab_result[11]);		
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Habitat de l'espèce",null,5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.habt, this.form.habt_select);'",$lib_reponse_reste['cg11'],"habt","");
				echo("</td><td>");
                metaform_sel_multi ("Habitat de l'espèce"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.habt_select, this.form.habt);'",$lib_reponse_edit['cg11'],"habt_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab","10","50","height:80px;",$ida[12],$ida_result[12]);
				echo("</td><td>");
                metaform_text_area ("Habitat de l'espèce"," no_lab","10","50","height:80px;",$ids[12],$ids_result[12]);
				echo("</td><td>");
                metaform_bout_plus ("Habitat de l'espèce"," no_lab",$fiab[12],$fiab_result[12]);				
				echo("</td></tr>");
			echo ("<tr valign=top >");
				echo("<td>");
				metaform_sel_multi ("Densité de la population",null,5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.dens_pop, this.form.dens_pop_select);'",$lib_reponse_reste['cg12'],"dens_pop","");
				echo("</td><td>");
                metaform_sel_multi ("Densité de la population"," no_lab",5,"width: 250px;","OnDblClick='javascript: deplacer( this.form.dens_pop_select, this.form.dens_pop);'",$lib_reponse_edit['cg12'],"dens_pop_select","");echo ("<br>");
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab","10","50","height:80px;",$ida[13],$ida_result[13]);
				echo("</td><td>");
                metaform_text_area ("Densité de la population"," no_lab","10","50","height:80px;",$ids[13],$ids_result[13]);
				echo("</td><td>");
                metaform_bout_plus ("Densité de la population"," no_lab",$fiab[13],$fiab_result[13]);				
				echo("</td></tr></table><br>");
        echo ("</fieldset>");
			echo ("</div>");
...
//------------------------------------------------------------------------------ EDIT EEE GRP5
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_eee_5']."</LEGEND>");
			...
			echo("</td><td width = \"400\" align=\"center\">");
                ...
                metaform_text_area ("Argumentation"," no_lab ","10","50","height:133;",$ida[14],$ida_result[14]);										
				echo ("<br>");
                metaform_text_area ("Argumentation"," no_lab ","10","50","height:133;",$ida[15],$ida_result[15]);										
				echo ("<br>");
                metaform_text_area ("Argumentation"," no_lab ","10","50","height:133;",$ida[16],$ida_result[16]);										
				echo ("<br><br>
				<br>");									
			echo("</td><td width = \"400\" align=\"left\">");
				...
				metaform_text_area ("A l'issu de l'évaluation, le taxon est considéré de la manière suivante"," no_lab","10","50","height:200;","eval_expert",$eval_expert);		
