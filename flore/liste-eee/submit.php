...
//------------------------------------------------------------------------------ Update
	...
	if (empty($reponse['ag1']) AND !empty($pays_choisis))	/*Nouvelle liste de pays*/
		{$query_ag['ag1'] = "INSERT INTO eee.reponse VALUES ($id, ".$idq['ag1'].", 'gl');";}
	...
	elseif ($idq['ag1'] != $reponse['ag1'] AND !empty($reponse['ag1']))	/*Modification de la liste des pays*/
		{$query_ag['ag1'] = "DELETE FROM eee.reponse WHERE uid = $id AND idq = ".$reponse['ag1']."; INSERT INTO eee.reponse VALUES ($id, ".$idq['ag1'].", 'gl');";}
	...
	if (empty($reponse['ag2']) AND !empty($pays_indi))	/*Nouvelle liste de pays*/
		{$query_ag['ag2'] = "INSERT INTO eee.reponse VALUES ($id, ".$idq['ag2'].", 'gl');";}
	...
	elseif ($idq['ag2'] != $reponse['ag2']  AND !empty($reponse['ag2']))	/*Modification de la liste des pays*/
		{$query_ag['ag2'] = "DELETE FROM eee.reponse WHERE uid = $id AND idq = ".$reponse['ag2']."; INSERT INTO eee.reponse VALUES ($id, ".$idq['ag2'].", 'gl');";}
	...
	if (empty($reponse['ag3']) AND !empty($pays_choisis))	/*Nouvelle liste de pays*/
		{$query_ag['ag3'] = "INSERT INTO eee.reponse VALUES ($id, ".$idq['ag3'].", 'gl');";}
	...
	elseif ($idq['ag3'] != $reponse['ag3']  AND !empty($reponse['ag3']))	/*Modification de la liste des pays*/
		{$query_ag['ag3'] = "DELETE FROM eee.reponse WHERE uid = $id AND idq = ".$reponse['ag3']."; INSERT INTO eee.reponse VALUES ($id, ".$idq['ag3'].", 'gl');";}
	...
	if (empty($reponse['ag4']) AND !empty($pays_choisis))	/*Nouvelle liste de pays*/
		{$query_ag['ag4'] = "INSERT INTO eee.reponse VALUES ($id, ".$idq['ag4'].", 'gl');";}
	...
	elseif ($idq['ag4'] != $reponse['ag4']  AND !empty($reponse['ag4']))	/*Modification de la liste des pays*/
		{$query_ag['ag4'] = "DELETE FROM eee.reponse WHERE uid = $id AND idq = ".$reponse['ag4']."; INSERT INTO eee.reponse VALUES ($id, ".$idq['ag4'].", 'gl');";}
	...
	if (empty($reponse['cg9']) AND !empty($pays_invav))	/*Nouvelle liste de pays*/
		{$query_ag['cg9'] = "INSERT INTO eee.reponse VALUES ($id, ".$idq['cg9'].", 'gl');";}
	...
	elseif ($idq['cg9'] != $reponse['cg9']  AND !empty($reponse['cg9']))	/*Modification de la liste des pays*/
		{$query_ag['cg9'] = "DELETE FROM eee.reponse WHERE uid = $id AND idq = ".$reponse['cg9']."; INSERT INTO eee.reponse VALUES ($id, ".$idq['cg9'].", 'gl');";}
...
//------------------------------------------------------------------------------ Suite et Fin du suivi
	...
	pg_free_result ($result);unset($val_1_idq);unset($val_2);
	...
	pg_free_result ($result);unset($val_1_eval);unset($val_2);
