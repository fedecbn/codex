...
echo ("</div>");
	...
	while ($row = pg_fetch_array($result))
		...
		<br>----MERCI DE NE PAS Y REPONDRE----
			...
			<br><br>Retrouvez la note d’information qui présente l'outil au lien suivant : <a href = \"".str_replace("www.","",$_SERVER["SERVER_NAME"])."/_DATA/150915_Note_ouverture_Codex.pdf\">Note d'information</a>
