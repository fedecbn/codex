...
//------------------------------------------------------------------------------ LISTE / User
    ...
    if (typeof user_oTable == 'undefined') {
        var user_oTable = $('#admin-user-liste').dataTable({
			...
			switch (aData[6]){case 'Pas d\'accès' :$('td:eq(5)', nRow).addClass('avancement_1');break;case 'Lecteur' : $('td:eq(5)', nRow).addClass('avancement_2'); break;case 'Participant' : $('td:eq(5)', nRow).addClass('avancement_3');break;case 'Evaluateur' : $('td:eq(5)', nRow).addClass('avancement_4');break;case 'Référent' : $('td:eq(5)', nRow).addClass('avancement_5');break;}
			switch (aData[7]){case 'Pas d\'accès' :$('td:eq(6)', nRow).addClass('avancement_1');break;case 'Lecteur' : $('td:eq(6)', nRow).addClass('avancement_2'); break;case 'Participant' : $('td:eq(6)', nRow).addClass('avancement_3');break;case 'Evaluateur' : $('td:eq(6)', nRow).addClass('avancement_4');break;case 'Référent' : $('td:eq(6)', nRow).addClass('avancement_5');break;}
			switch (aData[8]){case 'Pas d\'accès' :$('td:eq(7)', nRow).addClass('avancement_1');break;case 'Lecteur' : $('td:eq(7)', nRow).addClass('avancement_2'); break;case 'Participant' : $('td:eq(7)', nRow).addClass('avancement_3');break;case 'Evaluateur' : $('td:eq(7)', nRow).addClass('avancement_4');break;case 'Référent' : $('td:eq(7)', nRow).addClass('avancement_5');break;}
			switch (aData[9]){case 'Pas d\'accès' :$('td:eq(8)', nRow).addClass('avancement_1');break;case 'Lecteur' : $('td:eq(8)', nRow).addClass('avancement_2'); break;case 'Participant' : $('td:eq(8)', nRow).addClass('avancement_3');break;case 'Evaluateur' : $('td:eq(8)', nRow).addClass('avancement_4');break;case 'Référent' : $('td:eq(8)', nRow).addClass('avancement_5');break;}
			switch (aData[10]){case 'Pas d\'accès' :$('td:eq(9)', nRow).addClass('avancement_1');break;case 'Lecteur' : $('td:eq(9)', nRow).addClass('avancement_2'); break;case 'Participant' : $('td:eq(9)', nRow).addClass('avancement_3');break;case 'Evaluateur' : $('td:eq(9)', nRow).addClass('avancement_4');break;case 'Référent' : $('td:eq(9)', nRow).addClass('avancement_5');break;}
			switch (aData[11]){case 'oui' :$('td:eq(10)', nRow).addClass('oui');break;case 'non' : $('td:eq(10)', nRow).addClass('non'); break;}
			switch (aData[12]){case 'oui' :$('td:eq(11)', nRow).addClass('oui');break;case 'non' : $('td:eq(11)', nRow).addClass('non'); break;}
			switch (aData[13]){case 'oui' :$('td:eq(12)', nRow).addClass('oui');break;case 'non' : $('td:eq(12)', nRow).addClass('non'); break;}
			switch (aData[14]){case 'oui' :$('td:eq(13)', nRow).addClass('oui');break;case 'non' : $('td:eq(13)', nRow).addClass('non'); break;}
			switch (aData[15]){case 'oui' :$('td:eq(14)', nRow).addClass('oui');break;case 'non' : $('td:eq(14)', nRow).addClass('non'); break;}
			return nRow;
			},
			"oLanguage": { "sProcessing":   "Traitement en cours...",
                "sLengthMenu":   "Afficher _MENU_ éléments",
