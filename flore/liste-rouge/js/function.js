...
function eval () {
	...
	if (hybride_oui == 'TRUE' || indi == '3')	{		
		...
		for (i = 0; i < tbl_eval.length; i++){
		   ...
		   if (document.getElementById(tbl_eval[i]).type == "text")
				document.getElementById(tbl_eval[i]).value='';
			else if (document.getElementById(tbl_eval[i]).type == "select-one")
				document.getElementById(tbl_eval[i]).value=0;
	...
	$("#hybride1").change (eval);$("#hybride2").change (eval);$("#hybride3").change (eval);$("#cd_indi").change (eval);
...
// alert ('pr='+pr);
		if (isNaN (pr)){
            ...
            if (pr == '') { 
                ...
                document.getElementById('id_aoo').value=1;
    		} else if (pr >= 1 && pr < 10) {
                document.getElementById('id_aoo').value=2;
    		} else if (pr >= 10 && pr < 20) {
                document.getElementById('id_aoo').value=3;
    		} else if (pr >= 20 && pr < 30) {
                document.getElementById('id_aoo').value=4;
    		} else if (pr >= 30 && pr < 500) {
                document.getElementById('id_aoo').value=5;
    		} else if (pr >= 500 && pr < 2000) {
                document.getElementById('id_aoo').value=6;
    		} else if (pr >= 2000 && pr <3000) {
                document.getElementById('id_aoo').value=7;
    		} else if (pr >= 3000 ) {
                document.getElementById('id_aoo').value=8;
    		} else { 
                document.getElementById('id_aoo').value=0;
    		} 
			if (hybride_oui != 'TRUE' && indi != 'E') {		
	...
	function validatenblocprecis () {
		...
		if (isNaN (pr)){
            ...
            if (pr == 1) { 
                document.getElementById('id_nbloc').value=1;
            } else if (pr > 1 && pr <= 5) { 
                document.getElementById('id_nbloc').value=2;
    		} else if (pr > 5 && pr <= 10) {
                document.getElementById('id_nbloc').value=3;
    		} else if (pr > 10 && pr <= 15) {
                document.getElementById('id_nbloc').value=4;
    		} else if (pr > 15 ) {
                document.getElementById('id_nbloc').value=5;
    		} else { 
                document.getElementById('id_nbloc').value=0;
    		} 
			if (hybride_oui != 'TRUE' && indi != 'E') {		
				catb () ;
				catd2 ();	
	...
	function validatenbindivprecis () {
		...
		if (isNaN (pr)){
            ...
            if (pr == '') { 
                document.getElementById('id_nbindiv').value=0;
    		} else if (pr == 0) { 
                document.getElementById('id_nbindiv').value=1;
    		} else if (pr > 0 && pr < 50) {
                document.getElementById('id_nbindiv').value=2;
    		} else if (pr >= 50 && pr < 250) {
                document.getElementById('id_nbindiv').value=3;
    		} else if (pr >= 250 && pr < 1000) {
                document.getElementById('id_nbindiv').value=4;
    		} else if (pr >= 1000 && pr < 2000) {
                document.getElementById('id_nbindiv').value=5;
    		} else if (pr >= 2000 && pr < 2500) {
                document.getElementById('id_nbindiv').value=6;
    		} else if (pr >= 2500 && pr < 10000) {
                document.getElementById('id_nbindiv').value=7;
    		} else if (pr >= 10000 && pr <= 15000) {
                document.getElementById('id_nbindiv').value=8;
    		} else if (pr > 15000 ) {
                document.getElementById('id_nbindiv').value=9;
    		} else { 
                document.getElementById('id_nbindiv').value=10;
    		} 
			if (hybride_oui != 'TRUE' && indi != 'E') {		
				catc1 ();
				catc2 ();
	...
	function redeff_precis () {                                                
		...
		var hybride_oui=$("input[id=hybride1]:checked").val();						
		var indi=$("#cd_indi").val();
		if (obs1990_est == 0 && obs1990 != null)
			m = (obs1990 - obs2000)/obs1990;
		else if (obs1990_est < obs2000)
			m = 0;
		else 
			m = (obs1990_est - obs2000)/obs1990_est;
		// alert('m='+m);
	...
	function validatereduceffprecis () {
		...
		if (isNaN (pr) || (pr > 100 )){
            ...
            if (pr == 100) { 
                document.getElementById('id_reduc_eff').value=1;
    		} else if (pr >= 90 && pr < 100) {
                document.getElementById('id_reduc_eff').value=2;
    		} else if (pr >= 80 && pr < 90) {
                document.getElementById('id_reduc_eff').value=3;
    		} else if (pr >= 70 && pr < 80) {
                document.getElementById('id_reduc_eff').value=4;
    		} else if (pr >= 50 && pr < 70) {
                document.getElementById('id_reduc_eff').value=5;
    		} else if (pr >= 40 && pr < 50) {
                document.getElementById('id_reduc_eff').value=6;
    		} else if (pr >= 30 && pr < 40) {
                document.getElementById('id_reduc_eff').value=8;
    		} else if (pr >= 20 && pr < 30) {
                document.getElementById('id_reduc_eff').value=8;
    		} else if (pr < 20 && pr > 0) {
                document.getElementById('id_reduc_eff').value=9;
    		} else { 
                document.getElementById('id_reduc_eff').value=0;
    		} 
			if (hybride_oui != 'TRUE' && indi != 'E')
				crita2 ();
			return (true);
...
//------------------------------------------------------------------------------ FORM / Valeurs auto sur l'évaluation
	...
	function crita2 () {                                                         
		...
		if (reduc_eff == 0)
            document.getElementById('crit_a2').value=0;
        else if (reduc_eff == 9)
            document.getElementById('crit_a2').value=6;
		else if (reduc_eff == 8)
            document.getElementById('crit_a2').value=5;
		else if (reduc_eff == 7 || reduc_eff == 6)
            document.getElementById('crit_a2').value=4;
		else if (reduc_eff == 5 || reduc_eff == 4)
            document.getElementById('crit_a2').value=3;
		else if (reduc_eff == 3 || reduc_eff == 2)
            document.getElementById('crit_a2').value=2;
		else if (reduc_eff == 1)
            document.getElementById('crit_a2').value=1;
        else 
            document.getElementById('crit_a2').value=7;
		if (hybride_oui != 'TRUE' && indi != '3')	
			cata234 ();
		return (true);
    }	
	...
	function fcrit_a1() {   // Catégorie A1 & A
        ...
        switch (crit_a1) {
            case '1' : document.getElementById('cat_a1').value=2;
            break;
            case '2' : document.getElementById('cat_a1').value=3;
            break;
            case '3' : document.getElementById('cat_a1').value=4;
            break;
            case '4' : document.getElementById('cat_a1').value=5;
            break;
            case '5' : document.getElementById('cat_a1').value=6;
            break;
            case '6' : document.getElementById('cat_a1').value=7;
            break;
            case '7' : document.getElementById('cat_a1').value=8;
            break;
            case '0' : document.getElementById('cat_a1').value=0;
            break;
		}
		if (hybride_oui != 'TRUE' && indi != '3')		
			fcrit_a();
...
// alert ('min='+m);
        switch (m) {
            case 1 : document.getElementById('cat_a234').value=2;
            break;
            case 2 : document.getElementById('cat_a234').value=3;
            break;
            case 3 : document.getElementById('cat_a234').value=4;
            break;
            case 4 : document.getElementById('cat_a234').value=5;
            break;
            case 5 : document.getElementById('cat_a234').value=6;
            break;
            case 6 : document.getElementById('cat_a234').value=7;
            break;
            case 7 : document.getElementById('cat_a234').value=8;
            break;
            case 8 : document.getElementById('cat_a234').value=0;
            break;
		}
		if (hybride_oui != 'TRUE' && indi != '3')	
			fcrit_a();
	...
	function catb () {                                                          // Catégorie B
        ...
        if (aoo == 0 && nbloc == 0 && fragmt_sev== '' && a=='' && b=='' && c=='' && d=='' && e=='' && fa=='' && fb=='' && fc=='' && fd=='') 
            document.getElementById('cat_b').value=0;                           // CR*
        else if (aoo == 9) 
            document.getElementById('cat_b').value=8;                           // CR*
        else if (aoo == 1) 
            document.getElementById('cat_b').value=2;                           // CR*
            ...
            document.getElementById('cat_b').value=3;                           // CR
            ...
            document.getElementById('cat_b').value=4;                           // EN
            ...
            document.getElementById('cat_b').value=5;                           // VU
            ...
            document.getElementById('cat_b').value=5;
            ...
            document.getElementById('cat_b').value=6;                           // NT 
        else if (aoo == 2 && nbloc!=1 && fragmt_sev =='TRUE' && AND_declin(a!='TRUE',b!='TRUE',c!='TRUE',d!='TRUE',e!='TRUE') && AND_fluct(fa!='TRUE',fb!='TRUE',fc!='TRUE',fd!='TRUE'))
            document.getElementById('cat_b').value=6;                           // NT 
            ...
            document.getElementById('cat_b').value=8;                           // DD
        else 
            document.getElementById('cat_b').value=7;                           // LC
		if (hybride_oui != 'TRUE' && indi != '3')	
			catini();
		return (true);
    }
...
// alert ('critc1='+critc1);
        if (critc1 == 0 && nbindiv == 0)
            document.getElementById('cat_c1').value=0;
		else if (nbindiv == 1)
            document.getElementById('cat_c1').value=2;
        else if (nbindiv <= 3 && critc1 == 5)
            document.getElementById('cat_c1').value=3;
        else if (nbindiv <= 3 && critc1 >= 4)
            document.getElementById('cat_c1').value=4;
        else if (nbindiv <= 3 && critc1 >= 3)
            document.getElementById('cat_c1').value=5;
        else if (nbindiv <= 6 && critc1 >= 4)
            document.getElementById('cat_c1').value=4;
		else if (nbindiv <= 6 && critc1 >= 3)
            document.getElementById('cat_c1').value=5;
        else if (nbindiv <= 7 && critc1 >= 3)
            document.getElementById('cat_c1').value=5;
        else if (nbindiv == 9)
            document.getElementById('cat_c1').value=7;
        else if (nbindiv != 10 && nbindiv != 0)		
            document.getElementById('cat_c1').value=7;
        else if (nbindiv == 10 || nbindiv == 0 || critc1 == 1 || critc1 == 0)		//egale à null ou Inconnu
            document.getElementById('cat_c1').value=8;
        else 
            document.getElementById('cat_c1').value=7;
		if (hybride_oui != 'TRUE' && indi != '3')	
			catc();
	...
	function catc2 () {                                                         // Catégorie C2 & C
		...
		var indi=$("#id_indi").val();
// alert ('critc2='+critc2);
        if (critc2 == 0 && nbindiv == 0)
			document.getElementById('cat_c2').value=0;
		else if (nbindiv == 1)
            document.getElementById('cat_c2').value=2;
        else if (nbindiv <= 3 && critc2 == 1)
            document.getElementById('cat_c2').value=3;
        else if (nbindiv <= 3 && critc2 == 2)
            document.getElementById('cat_c2').value=4;
        else if (nbindiv <= 3 && critc2 == 3)
            document.getElementById('cat_c2').value=5;
        else if (nbindiv <= 6 && (critc2 == 1 || critc2 == 2))
            document.getElementById('cat_c2').value=4;
		else if (nbindiv <= 6 && critc2 == 3)
            document.getElementById('cat_c2').value=5;
        else if (nbindiv <= 7 && (critc2 == 1 || critc2 == 2 || critc2 == 3))
            document.getElementById('cat_c2').value=5;
        else if (nbindiv != 10 && nbindiv != 0)		
            document.getElementById('cat_c2').value=7;
        else if (nbindiv == 10 || nbindiv == 0 || critc2 == 4 || critc2 == 0)	//egale à null ou Inconnu
            document.getElementById('cat_c2').value=8;
        else 
            document.getElementById('cat_c2').value=7;
		if (hybride_oui != 'TRUE' && indi != '3')	
			catc();
	...
	function catd1 () {                                                          // Catégorie D
		...
		var indi=$("#id_indi").val();
        if (nbindiv == 0)
            document.getElementById('cat_d1').value=0;
        else if (nbindiv == 1)
            document.getElementById('cat_d1').value=8;
        else if (nbindiv == 2)
            document.getElementById('cat_d1').value=3;
        else if (nbindiv == 3)
            document.getElementById('cat_d1').value=4;
        else if (nbindiv == 4)
            document.getElementById('cat_d1').value=5;
		else if (nbindiv == 5)		
            document.getElementById('cat_d1').value=6;
		else if (nbindiv == 10)		
            document.getElementById('cat_d1').value=8;
        else 
            document.getElementById('cat_d1').value=7;
 		if (hybride_oui != 'TRUE' && indi != '3')	
			catd ();
		return (true);
    }
	...
	function catd2 () {                                                          // Catégorie D
		...
		var hybride_oui=$("input[id=hybride1]:checked").val();						
		var indi=$("#id_indi").val();
        if (menace == ''  && aoo==0 && nbloc==0)	
            { document.getElementById('cat_d2').value=0;
            document.getElementById('crit_d2').value=''; }
        else if (menace == '' || (aoo==0 && nbloc==0))	
            { document.getElementById('cat_d2').value=8;
            document.getElementById('crit_d2').value=''; }
        else if (menace == 'TRUE' && (aoo!=0 && aoo <=3))
            { document.getElementById('cat_d2').value=5;
            document.getElementById('crit_d2').value='menace et aoo < 20km²'; }			
        else if (menace == 'TRUE' && (nbloc==2 || nbloc == 1))
            { document.getElementById('cat_d2').value=5;
            document.getElementById('crit_d2').value='menace et nb de localité <=5'; }			
        else if (menace == 'TRUE' && aoo!=0 && aoo <=4)		
            { document.getElementById('cat_d2').value=6;
			document.getElementById('crit_d2').value='menace et aoo < 30km²'; }		
        else if (menace == 'FALSE' && aoo!=0 && aoo <=3)		
            { document.getElementById('cat_d2').value=6;
			document.getElementById('crit_d2').value='pas de menace et aoo < 20km²'; }			
        else 
            { document.getElementById('cat_d2').value=7;
			document.getElementById('crit_d2').value=''; }
		if (hybride_oui != 'TRUE' && indi != '3')	
			catd ();
		return (true);
...
// alert ('m='+m);
	...
	function catfin () {                                                        // Catégorie init
		...
		if (categ_ini == 0)
            document.getElementById('cat_fin').value = 0;
		else
            document.getElementById('cat_fin').value = parseInt(categ_ini) + parseInt(ajust);
		return (true);
    }
