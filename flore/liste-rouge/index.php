...
//------------------------------------------------------------------------------ EDIT LR GRP1
        ...
        echo ("<fieldset><LEGEND>".$lang[$lang_select]['groupe_lr_1']."</LEGEND>");
				...
				echo ("<td style=\"width: 800px;\">");
					metaform_text ("Nom scientifique",$desc,100,"","nom_sci",pg_result($result,0,"nom_sci"));
					metaform_text ("Nom vernaculaire",$desc,100,"","nom_vern",pg_result($result,0,"nom_vern"));
					metaform_bout ("Taxon hybride?",$desc,"","hybride",pg_result($result,0,"hybride"));
				echo ("</td><td>");	
					metaform_text ("Code REF.",$desc,8,"","cd_ref",pg_result($result,0,"cd_ref"));
					metaform_sel ("Rang",$desc,"",$ref[$champ_ref['id_rang']],"id_rang",pg_result($result,0,"id_rang"));
				echo ("</td><td>");	
					if ($niveau >= 128)
...
//------------------------------------------------------------------------------ EDIT LR GRP2
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_lr_2']."</LEGEND>");
            echo ("<table border=0 width=\"100%\"><tr valign=top ><td width=33%>");
                ...
                metaform_text ("Indigénat Synthèse régions",$desc,8,"","indi_cal",pg_result($result,0,"indi_cal"));
            ...
            echo ("</td><td width=33%>");
                echo ("<br>");
                metaform_text ("AOO (1 km²) - calculé",$desc,5,"","aoo1",pg_result($result,0,"aoo1"));
                metaform_text ("AOO (4 km²) - calculé",$desc,5,"","aoo4",pg_result($result,0,"aoo4"));
            ...
            echo ("</td><td width=33%>");
                ...
                metaform_text (" observé >=1990 - calculé",$desc,5,"","nbm5_post1990",pg_result($result,0,"nbm5_post1990"));
                metaform_text (" observé >=2000 - calculé",$desc,5,"","nbm5_post2000",pg_result($result,0,"nbm5_post2000"));
                metaform_text (" observé total - calculé",$desc,5,"","nbm5_total",pg_result($result,0,"nbm5_total"));
                echo ("<h4>Nombre de commune(s)</h4>");
                metaform_text (" observé >=1990 - calculé",$desc,5,"","nbcommune",pg_result($result,0,"nbcommune"));
            echo ("</td></tr></table><br>");
        echo ("</fieldset>");
//------------------------------------------------------------------------------ EDIT LR GRP3
...
//------------------------------------------------------------------------------ EDIT LR GRP4
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_lr_4']."</LEGEND>");
            ...
            echo ("</td><td width=100>");
				echo ("<br>");
	            metaform_text ("Cat synthèse régionale",$desc,10,"","cat_synt_reg",$ref['categorie_final'][pg_result($result,0,"cat_synt_reg")]);
            ...
            echo ("</td><td width=100>");
				echo ("<br>");
	            metaform_text ("Nb région(s) taxon présent",$desc,10,"","nb_reg_presence",pg_result($result,0,"nb_reg_presence"));
	            metaform_text ("Nb région(s) taxon évalué",$desc,10,"","nb_reg_evalue",pg_result($result,0,"nb_reg_evalue"));
            ...
            echo ("</td></tr></table><br>");
            echo ("<label class=\"preField_calc\">Notes</label><textarea name=\"notes\" disabled style=\"width:60em;background-color: #EFEFEF;\" rows=\"2\" >".pg_result($result,0,"notes")."</textarea><br><br>");
