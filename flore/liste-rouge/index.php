...
//------------------------------------------------------------------------------ EDIT LR GRP2
        ...
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_lr_2']."</LEGEND>");
            ...
            echo ("</td><td width=33%>");
                echo ("<br>");
                metaform_text ("AOO (km²) 1","",5,"readonly disabled","aoo1",pg_result($result,0,"aoo1"));
                metaform_text ("AOO (km²) 4","",5,"readonly disabled","aoo4",pg_result($result,0,"aoo4"));
            ...
            echo ("</td><td width=33%>");
                ...
                metaform_text (" >=1990","",5,"readonly disabled","nbm5_post1990",pg_result($result,0,"nbm5_post1990"));
                metaform_text (" >=2000 ","",5,"readonly disabled","nbm5_post2000",pg_result($result,0,"nbm5_post2000"));
                metaform_text (" Total ","",5,"readonly disabled","nbm5_total",pg_result($result,0,"nbm5_total"));
                echo ("<h4>Nombre de commune(s)</h4>");
                metaform_text (" >=1990","",5,"readonly disabled","nbcommune",pg_result($result,0,"nbcommune"));
            echo ("</td></tr></table><br>");
        echo ("</fieldset>");
//------------------------------------------------------------------------------ EDIT LR GRP3
...
//------------------------------------------------------------------------------ EDIT LR GRP4
        echo ("<fieldset><LEGEND> ".$lang[$lang_select]['groupe_lr_4']."</LEGEND>");
            ...
            echo ("<table border=0 width=\"100%\"><tr valign=top ><td width=250>");
                echo ("<br>");
               metaform_text ("Catégorie Préced","",10,"disabled","cat_preced",$ref['categorie_final'][pg_result($result,0,"cat_preced")]);
                metaform_text ("Critère(s) Préced","",10,"disabled","just_preced",pg_result($result,0,"just_preced"));
            echo ("</td><td width=250>");
                echo ("<br>");
               metaform_text ("Catégorie EU","",10,"disabled","cat_euro",$ref['categorie_final'][pg_result($result,0,"cat_euro")]);
                metaform_text ("Critère(s) EU","",10,"disabled","just_euro",pg_result($result,0,"just_euro"));
            echo ("</td><td width=100>");
				echo ("<br>");
	            metaform_text ("Cat synthèse régionale","",10,"disabled","cat_synt_reg",$ref['categorie_final'][pg_result($result,0,"cat_synt_reg")]);
				echo ("<label class=\"preField\">Crit synthèse régionale</label><textarea name=\"just_synt_reg\" size=10 readonly disabled cols=\"50\" rows=\"1\" style=\"height: 27px;\">".pg_result($result,0,"just_synt_reg")."</textarea><br><br>");
            echo ("</td><td width=100>");
				echo ("<br>");
	            metaform_text ("Nb région(s) taxon présent","",10,"disabled","nb_reg_presence",pg_result($result,0,"nb_reg_presence"));
	            metaform_text ("Nb région(s) taxon évalué","",10,"disabled","nb_reg_evalue",pg_result($result,0,"nb_reg_evalue"));
