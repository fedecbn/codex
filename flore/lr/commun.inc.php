...
$query_liste = "
	...
	LEFT OUTER JOIN lr.validation ON validation.uid=taxons.uid  AND evaluation.etape = validation.etape_val AND evaluation.version = validation.version_val AND id_user = '$id_user'
